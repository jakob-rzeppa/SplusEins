// Mock OSM data
jest.mock('../../../assets/overpass_osm/WF.json', () => ({
  "test-room": { id: 11111111, level: "1" }
}), { virtual: true });
jest.mock('../../../assets/overpass_osm/SZ.json', () => ({
  "test-room": { id: 22222222, level: "1" }
}), { virtual: true });
jest.mock('../../../assets/overpass_osm/SUD.json', () => ({
  "test-room": { id: 333333333, level: "1" }
}), { virtual: true });
jest.mock('../../../assets/overpass_osm/WOB.json', () => ({
